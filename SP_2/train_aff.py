...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", type=str, default='weights/ilsvrc-cls_rna-a1_cls1000_ep-0001.params')
    parser.add_argument("--voc12_root", default='./VOC2012', type=str)
    parser.add_argument("--la_crf_dir", type=str, default='save/out_crf_0.60')
    parser.add_argument("--ha_crf_dir", type=str, default='save/out_crf_0.25')
