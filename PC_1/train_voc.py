...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_epoches", default=14, type=int)
    ...
    parser.add_argument("--session_name", default="PC_240408", type=str)
    ...
    for ep in range(args.max_epoches):
        print('train_ep:', ep)
        train_dataset = voc12.data.VOC12ClsDataset_PC(args.train_list, voc12_root=args.voc12_root,
                                                          epoch=ep,
        ...
        for iter, pack in enumerate(train_data_loader):
            ...
            logits_conv1, logits_trans1, cams1 = model('transcam', img1)
            loss1 = F.multilabel_soft_margin_loss((logits_conv1 + logits_trans1).unsqueeze(2).unsqueeze(3)[:, 1:, :, :],
                                                  label[:, 1:, :, :])



            logits_conv2, logits_trans2, cams2 = model('transcam', img2)
