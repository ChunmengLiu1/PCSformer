...
class VOC12ClsDataset_PC(VOC12ImageDataset):
    ...
    def __getitem__(self, idx):
        ...
        if parent != 'Image':
            img1 = img
            img2 = F.interpolate(img.unsqueeze(0), (224, 224), mode='bilinear', align_corners=False).squeeze(0)

            return name, img, label, img1, img2
        else:
